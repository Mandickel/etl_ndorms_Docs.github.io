...
|person_id | e_patid | | |
|condition_concept_id | morph_icd10_o2, behaviour_icd10_o2, site_icd10_o2 | WITH ct1 AS (SELECT CONCAT(morph_icd10_o2, '/', behaviour_icd10_o2, '-', site_icd10_o2, '.9') AS condition_source_value FROM tumour)SELECT t1.concept_id FROM public.concept AS t1 INNER JOIN ct1 AS t2 ON t1.concept_code = t2.condition_source_value;| CONDITION_CONCEPT_ID will be mapped to standard SNOMED Concept_id by using morph_icd10_o2,behavior_icd10_o2,site-icd10_o2|
