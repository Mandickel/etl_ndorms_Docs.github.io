...
| visit_detail_start_date | epistart,<br>admidate | If epistart is null then use admidate|    |
| visit_detail_start_datetime| epistart,<br>admidate,<br>disdate | |  |
| visit_detail_end_date | epiend,<br>disdate,<br>epistart,<br>admidate | If epiend is null then use any of these if not null (disdate, epistart, admidate)|  |
