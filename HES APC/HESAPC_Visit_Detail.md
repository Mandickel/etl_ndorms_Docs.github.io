...
Take the carefully selected records from HES APC tables hes_episodes, hes_acp,and hes_ccare and map the as demonstrated in the figure below.

*Reading from hes_episodes table:*
![](images/image4.png)
